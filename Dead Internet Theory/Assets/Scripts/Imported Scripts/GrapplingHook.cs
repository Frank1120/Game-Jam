...
namespace ShadowedSouls
{
    ...
    #region Variables
        ...
        // [CAN BE CHANGED]
        private ThirdPersonController playerControl;         // Unity Standard Assets 
    ...
    #region StartUpdates
        void Start()
        {
            ...
            // [CAN BE CHANGED]
            playerControl = GetComponentInParent<ThirdPersonController>();
        ...
        void FixedUpdate()
        {
            if (!firedHook)
            {
                ...
                if (Input.GetKeyDown(KeyCode.Mouse1) == true)
                {
                    ...
                    {
                        if (hitt.collider.CompareTag("Hookable") || hitt.collider.CompareTag("Climbable")) 
                        {
